...
# Rotas
app.include_router(
    client_routes.router, tags=["Clients"], dependencies=[Depends(security_scheme)]
)
app.include_router(
    professional_routes.router,
    tags=["Professionals"],
    dependencies=[Depends(security_scheme)],
)
app.include_router(
    service_routes.router, tags=["Services"], dependencies=[Depends(security_scheme)]
)
app.include_router(
...
app.include_router(
    report_route.router, tags=["Report"], dependencies=[Depends(security_scheme)]
)
app.include_router(
    tenant_routes.router, tags=["Tenants"], dependencies=[Depends(security_scheme)]
)
app.include_router(
    auth_routes.router, tags=["Auth"], dependencies=[Depends(security_scheme)]
)
